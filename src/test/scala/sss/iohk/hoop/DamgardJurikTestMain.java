...
public class DamgardJurikTestMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SigmaProverInput input = new SigmaDJProductProverInput(pKey,
        ...
        SigmaDJProductCommonInput commonInput = new SigmaDJProductCommonInput(pKey, num_a_enc, num_b_enc, num_c_enc);
